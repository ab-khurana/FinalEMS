...
<body>
	<center>
		<font size="5" color="Red">Project Allocations:</font> <br> <br>
		<form action="allocate" method="post">
			<%
				java.util.List dataList = (List) request.getSession().getAttribute(
						"somename");
				java.util.Iterator itr = dataList.iterator();
			%>
			<br> <br> <br> <br> <br> <br> <br>
			<br> Project name: <select name="projectname">
				...
				%>
			</select> <br> <br> Designation: <select name="designation">
			...
			Employee name: <select name="employeename">
				...
				%>
				<option value="<%out.print(employeename);%>">
					<%
				...
				%>
			</select> <br> <br> Start Date (YYYY-MM-DD Format Only): <input
				type="date" name="startdate" value=""> <br> <br>
			End Date (YYYY-MM-DD Format Only): <input type="date" name="enddate"
				value=""> <br> <br> 
